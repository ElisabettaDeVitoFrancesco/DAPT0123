...
----------------------------------------------------------------------------------------------------
-- Creazione delle relazioni seguendo il modello logico creato:
-- SALES CUSTOMERS PRODUCTS PRODUCT_SUBCATEGORY PRODUCT_CATEGORY E-SELLERS DATE TERRITORY ADDRESS
----------------------------------------------------------------------------------------------------

DROP TABLE IF EXISTS DATES;
CREATE TABLE DATES (
	date_ID INT PRIMARY KEY IDENTITY, -- AUTO_INCREMENT in MySQL
	dates DATE NOT NULL
); -- engine = innodb; in MySQL

DROP TABLE IF EXISTS TERRITORY;
CREATE TABLE TERRITORY (
	territory_ID INT PRIMARY KEY IDENTITY, -- AUTO_INCREMENT in MySQL
...
CREATE TABLE ADDRESSES (
	address_ID INT PRIMARY KEY IDENTITY, -- AUTO_INCREMENT in MySQL
...
CREATE TABLE E_SELLERS (
	seller_ID INT PRIMARY KEY IDENTITY, -- AUTO_INCREMENT in MySQL
...
CREATE TABLE PRODUCT_CATEGORY (
	cat_ID INT PRIMARY KEY IDENTITY, -- AUTO_INCREMENT in MySQL
	cat_name VARCHAR(255) NOT NULL
); -- engine = innodb; in MySQL

DROP TABLE IF EXISTS PRODUCT_SUBCATEGORY;
CREATE TABLE PRODUCT_SUBCATEGORY (
	subcat_ID INT PRIMARY KEY IDENTITY, -- AUTO_INCREMENT in MySQL
...
CREATE TABLE PRODUCTS (
	product_ID INT PRIMARY KEY IDENTITY, -- AUTO_INCREMENT in MySQL
...
CREATE TABLE CUSTOMERS  (
	customer_ID INT PRIMARY KEY IDENTITY, -- AUTO_INCREMENT in MySQL
...
DROP VIEW IF EXISTS sales_dates;
